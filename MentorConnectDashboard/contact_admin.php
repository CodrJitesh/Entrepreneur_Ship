        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    ...
                    <a href="contact_admin.php" class="flex items-center px-4 py-2 text-gray-700 bg-orange-100 rounded-lg">
        ...
        <div class="flex-1 p-8">
            <div class="max-w-2xl mx-auto">
                <div class="bg-white rounded-lg shadow-md p-8">
                    <h1 class="text-3xl font-bold text-gray-800 mb-6">Contact Admin</h1>
